...
import { Card, Button, Input, Modal, PageLoader } from "@/app/components/ui";
...
import { loadPinHash, savePinHash } from "@/app/hooks/usePin";
        ...
        <div className="max-w-2xl mx-auto space-y-5">
          ...
          <Card padding="lg">
            ...
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "var(--cf-card-3)" }}>
                  {/* Logo oficial do Google — cores da marca, não do design system. */}
